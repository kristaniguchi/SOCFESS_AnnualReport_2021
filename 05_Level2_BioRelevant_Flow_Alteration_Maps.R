#05 SOC FESS Level 2: Biologically-relevant flow alteration assessment for all subbasins modeled in LSCP
#This code takes the alteration assessment summary table and generates alteration maps for each FFM, synthesis alteration across flow components
#Source code for Figure XX in main text of final report SOC FESS
...
#directory where Level 2 data is saved at
level2.dir <- "C:/Users/KristineT.SCCWRP2K/SCCWRP/SOC WQIP - Flow Ecology Study - General/Tier2_analysis/"
...
#read in level 2 synthesis summary data - csv saved at (SOC_CSCI_ASCI_HydroAlt_Synthesis_Summary.csv)
synthesis.summary <- read.csv("C:/Users/KristineT.SCCWRP2K/SCCWRP/SOC WQIP - Flow Ecology Study - General/Data_Products/AnnualReport_2020/Flow Ecology Level 2/Overall Prioritization (Combining CSCI and ASCI)/SOC_CSCI_ASCI_HydroAlt_Synthesis_Summary.csv")

#read in a reformatted level 2 synthesis summary data used for CSCI/ASCI plots - saved in GitHub repository
subset <- read.csv("C:/Users/KristineT.SCCWRP2K/Documents/Git/SOCFESS_2021AnnualReport/summary_bioflowalteartion.csci.asci.csv")
...
#read in shapefiles subbasins and reaches -  saved in github repository in data folder
...
############################################################
#May need to add in synthesis alteration determination piece of code



############################################################
#Biologically-Relevant Flow Alteration Maps for CSCI and ASCI 
#Code to produce maps for CSCI () and ASCI ()
#Suitability maps for XX% probability of achieving healthy bio threshold, for XX% of time
